...
public class WallSpawner : MonoBehaviour
{
    ...
    public float minSpawnTime = 7.5f; // Minimum amount of time between spawning objects
    public float maxSpawnTime = 15.0f; // Maximum amount of time between spawning objects
