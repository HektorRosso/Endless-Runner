...
public class WallSpawner : MonoBehaviour
{
    ...
    public float minSpawnTime = 15.0f; // Minimum amount of time between spawning objects
    public float maxSpawnTime = 30.0f; // Maximum amount of time between spawning objects
